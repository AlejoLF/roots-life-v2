  ...
  return (
    <>
      ...
      <main className="relative z-10 pt-[58px] lg:pt-[72px] flex-1">
        {/* Banner — full-bleed cinematic 21:9 */}
        <section
        ...
        >
          <div className="relative text-center px-4 py-6 max-w-[42rem] text-paper-100">
            ...
            <p className="text-body md:text-body-lg text-paper-200 max-w-[32rem] mx-auto">
        ...
        {/* Intro */}
        <section className="py-10 lg:py-12 px-4 md:px-8 lg:px-12 max-w-[42rem] mx-auto text-center">
          <p className="text-body lg:text-body-lg text-ink-500 leading-relaxed m-0">
        ...
        <section className="bg-ink-900 text-paper-100 halftone-dark py-16 lg:py-16 px-4 md:px-8 lg:px-12">
          <div className="max-w-[75rem] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-8 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="text-body lg:text-body-lg text-paper-200 leading-relaxed m-0">
